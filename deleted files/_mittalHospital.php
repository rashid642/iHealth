...
<body>
  ...
  <div class="content">
    ...
    <div class="card">
      ...
      <div class="card-text">
        <a href="http://localhost/iHealth/doctorpages/drprofile.php?drusername=prenagarga">
    ...
    <div class="card">
      ...
      <div class="card-text">
        <a href="http://localhost/iHealth/doctorpages/drprofile.php?drusername=sobhadeshmuk">
          <h1>Dr. Sobha Deshmukh</h1>
        </a>
        <p><b>Obstetrics & Gynecology/b></p>
        <p>Monday-Friday</p>
        <p>10:00AM-1:00PM</p>
